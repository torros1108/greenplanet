...
export const initialProducts: Product[] = [
  { id: "p1", title: "Linen baby sleeper", brand: "Babyly", category: "Baby & barsel", tags: ["baby", "linen", "barsel"], description: "Blød babysleeper i hor til en rolig barselsgave.", cost: 345.34, price: 690.69, stock: 4, sku: "BABYLY-SLEEPER", image: "https://cdn.faire.com/fastly/0a4b47c9202f6e86eb7fc4f9ac12be65afbd26a83c5ea8198f5fc3227639fa68.jpeg", giftbox: true, occasions: ["Barsel", "Baby gave"], shape: "box", status: "Live" },
  { id: "p2", title: "Linen babynest", brand: "Babyly", category: "Baby & barsel", tags: ["baby", "babynest"], description: "Linen babynest fra tidligere Faire-bestilling.", cost: 407.93, price: 815.86, stock: 2, sku: "BABYLY-NEST", variants: [{ id: "p2-beige", title: "Beige", sku: "BABYLY-NEST-BEIGE", price: 815.86, stock: 1, status: "live" }, { id: "p2-sea-blue", title: "Sea blue", sku: "BABYLY-NEST-SEA-BLUE", price: 815.86, stock: 1, status: "live" }, { id: "p2-forest-green", title: "Forest green", sku: "BABYLY-NEST-FOREST-GREEN", price: 815.86, stock: 0, status: "live" }], image: "https://cdn.faire.com/fastly/81b057e82552add927d1a2040ad353dbb3c89a2244af930cc0dd7a12b7f2137c.jpeg", giftbox: true, occasions: ["Barsel", "Baby gave"], shape: "box", status: "Live" },
...
export function productSpecs(product: Product) {
  ...
  const byProduct: Record<string, { label: string; value: string }[]> = {
    p1: [
      ...
      { label: "Variant", value: "Beige / powder pink fra Faire-options" },
    ...
    p2: [
      ...
      { label: "Variant", value: "Beige / sea blue / forest green fra Faire-options" },
